...
App.prototype.renderMoviePage = function(){
  this.favoritePage ? this.mainDiv.innerHTML += this.currentMovie.html : this.mainDiv.innerHTML = this.currentMovie.html; // if we are rendering the favorites, keep adding to the dom, else, clear the dom and just add the one movie as a show page. Kind of hacky.
}
